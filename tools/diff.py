...
filename1 = "/Users/cindy.wang/Downloads/old/result-21-days-daegu-raw.csv"
filename2 = "/Users/cindy.wang/Downloads/new/result-21-days-daegu-raw.csv"
        ...
        for line1, line2 in itertools.izip(reader1, reader2):
            if line1 != line2:
                ...
                for item1, item2 in itertools.izip(strs1, strs2):
                    if(item1 != item2 and abs(float(item1) - float(item2)) > 0.011):
                            print(strs1[0])